...
import { ArrowRightIcon, Briefcase, CheckCircle2, TrendingUp } from "lucide-react";
    ...
    <div className="flex min-h-screen flex-col bg-background">
      <main className="flex-1">
        <section className="container mx-auto px-4 py-28 max-w-4xl text-center">
          <div>
            <h1 className="text-foreground mb-6 text-5xl font-bold">A better way to track your job application</h1>
